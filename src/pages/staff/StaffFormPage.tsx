          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
            ...
            <div className="md:col-span-2 space-y-8 pt-6 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">Staff unique ID No. (System Generated)</label>
                  <input
                    {...register('staffId')}
                    readOnly
                    placeholder="Auto-generating ID..."
                    className="w-full px-6 py-4 bg-gray-150 border border-gray-200 rounded-2xl outline-none font-bold text-gray-400 cursor-not-allowed select-none"
                    title="Staff ID is automatically generated by the system"
                  />
                </div>
            ...
            <div className="md:col-span-2 space-y-3 pt-4">
              ...
              <div className="relative">
                ...
                <input
                  {...register('licenseNo')}
                  placeholder="e.g. SL-12345/WP"
                  className="w-full pl-12 pr-4 py-4 bg-indigo-50/50 border border-indigo-100/50 rounded-2xl focus:ring-1 focus:ring-indigo-400 outline-none transition-all font-mono font-bold text-indigo-600 placeholder:text-indigo-300"
                />
              </div>
            </div>
