          ...
          <div className="overflow-x-auto">
                  ...
                  >
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-bold text-white group-hover:text-indigo-400 transition-colors uppercase tracking-tight">{customer.name}</p>
                          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">{customer.nickname || 'No Nickname'}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-5">
                      <span className="px-2 py-1 text-[10px] uppercase font-black tracking-widest rounded border bg-white/5 border-white/10 text-gray-400">
                        {customer.brNo}
                      </span>
                    </td>
                    <td className="px-8 py-5">
                      <p className="text-sm text-gray-400">{customer.officialContact}</p>
                    </td>
                    <td className="px-8 py-5">
                    ...
                    <td className="px-8 py-5 text-right" onClick={e => e.stopPropagation()}>
                      <div className="flex items-center justify-end space-x-1 opacity-0 group-hover:opacity-100 transition-all">
                        <PermissionGate permission="edit_customers">
                          <Link to={`/customers/${customer.id}/edit`} className="p-2 text-gray-500 hover:text-white transition-colors">
            ...
            {filteredCustomers.length === 0 && (
              <div className="py-24 text-center">
                <p className="text-gray-500 text-sm font-bold uppercase tracking-widest">No clients found in registry.</p>
              </div>
            )}
          </div>
        )}
