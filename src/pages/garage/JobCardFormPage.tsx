...
const jobCardSchema = z.object({
  ...
  meterReading: z.number({ error: 'Enter meter reading' }).min(0).optional(),
  technicianName: z.string().min(1, 'Technician name required'),
  estimatedHrs: z.number({ error: 'Enter hours' }).min(0).optional(),
  ...
  actualHrs: z.number({ error: 'Enter hours' }).min(0).optional(),
