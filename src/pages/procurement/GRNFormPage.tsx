  ...
  return (
    <div className="max-w-5xl mx-auto pb-20">
      <div className="flex items-center gap-4 mb-2">
         ...
         <PageHeader 
          title="Reception Protocol" 
          subtitle="Verifying physical supply chain arrivals against procurement intent."
         />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        >
           ...
           {/* Section: Cargo Audit (Line Items) */}
           <div className="space-y-6">
              <div className="flex items-center justify-between px-1">
                 <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-[11px] font-black text-gray-900 uppercase tracking-[0.3em]">Cargo Audit Ledger</h3>
                 </div>
                 <button 
                  type="button"
                    ...
                    {fields.map((field, index) => (
                       ...
                       >
                          <div className="col-span-12 md:col-span-5 space-y-2">
                             <label className="text-[8px] font-black text-gray-400 uppercase tracking-widest px-1">Cargo Description</label>
                             <input 
                              type="text" 
                          ...
                          <div className="col-span-4 md:col-span-2 space-y-2">
                             <label className="text-[8px] font-black text-indigo-600 uppercase tracking-widest px-1">Intent (Qty)</label>
                             <input 
                              type="number" 
                          ...
                          <div className="col-span-4 md:col-span-2 space-y-2">
                             <label className="text-[8px] font-black text-emerald-600 uppercase tracking-widest px-1">Actual (Qty)</label>
                             <input 
                              type="number" 
